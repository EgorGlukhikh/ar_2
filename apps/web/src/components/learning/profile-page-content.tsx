                ...
                <label className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[var(--foreground)]">
                      Получать письма о новых курсах, наборах и полезных сценариях платформы
                    </p>
                    <p className="mt-1 text-sm leading-6 text-[var(--muted)]">
                      Сервисные письма о доступе, оплате и важных событиях приходят всегда, даже
                      если маркетинговые письма выключены.
                    </p>
                  </div>
                </label>
              </div>
