...
import { BookOpen, PlayCircle, ShieldCheck, Tv } from "lucide-react";
...
import { LandingCourseCarousel } from "@/components/marketing/landing-course-carousel";
        ...
        <PageGrid className="items-start">
          <div className="xl:col-span-4">
            <LayoutSectionLead
              ...
              description="Для автора и команды курса есть отдельный контур: структура программы, уроки, задания, студенты и база знаний по работе с курсом."
            />
          </div>
            ...
            <PageGrid className="items-stretch">
              ...
              <div className="grid gap-4 xl:col-span-5">
                <MotionReveal variant="scale" delay={80}>
                  <SiteIllustration
                    kind="designProcess"
                    alt="Иллюстрация авторского кабинета"
                    className="h-full"
                  />
                </MotionReveal>
                <MotionReveal variant="up" delay={120}>
                  <article className={publicCardClassName}>
                    ...
                    <h3 className="mt-4 text-xl font-semibold leading-7 text-[var(--foreground)]">
                      <Copy value="Из курса — в каталог" />
                    </h3>
                    <p className="mt-3 text-base leading-7 text-[var(--muted)]">
                      <Copy value="Курс выглядит как продукт: есть структура, карточка, формат, цена и понятный следующий шаг для ученика." />
                    </p>
                  </article>
                </MotionReveal>
              </div>
