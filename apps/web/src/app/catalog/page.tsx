            ...
            <div className="grid gap-8 py-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
              <div className="space-y-8">
                <SectionLead
                  ...
                  text="Здесь видны опубликованные программы, их стоимость и сценарий получения доступа. Реальный платежный провайдер позже заменит демонстрационный поток оплаты, но сама витрина останется такой же."
                />

                <div className="grid gap-4 sm:grid-cols-3">
                  {[
                    { icon: BookOpenText, label: "Опубликовано", value: `${courses.length} программ` },
                    { icon: WalletCards, label: "Сценарий", value: "Демо-оплата" },
