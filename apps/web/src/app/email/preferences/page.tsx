  ...
  return (
    <section className="mx-auto flex min-h-[70vh] w-full max-w-[720px] items-center px-6 py-16">
      <div className="w-full rounded-[32px] border border-[var(--border)] bg-white p-8 shadow-[var(--shadow-lg)]">
        ...
        <p className="mt-4 text-sm leading-7 text-[var(--muted)]">
          Вы можете управлять своими подписками на рассылки Академии риэлторов. Здесь можно
          включить или выключить маркетинговые письма. Сервисные письма о доступе, оплате и
          безопасности аккаунта продолжают приходить всегда.
        </p>
          ...
          <label className="flex items-start gap-3 rounded-[24px] border border-[var(--border)] bg-[var(--surface)] px-5 py-4">
            ...
            <div>
              <p className="text-sm font-semibold text-[var(--foreground)]">
                Получать новости, информацию о новых курсах, акциях и приглашения на вебинары и
                мероприятия
              </p>
              <p className="mt-1 text-sm leading-6 text-[var(--muted)]">
                Вы можете в любой момент вернуться на эту страницу и изменить выбор или полностью
                отказаться от маркетинговых писем.
              </p>
            </div>
          </label>
