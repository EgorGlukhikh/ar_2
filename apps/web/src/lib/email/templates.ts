  ...
  switch (step) {
    ...
    case 3:
      return renderEmailTemplate({
        ...
        intro: "Витрина, карточка курса, цена, шаг оплаты и выдача доступа должны выглядеть как один продуктовый поток. Тогда платформа начинает работать на продажи.",
        sections: [
          {
