...
export const emailTemplateCatalog: EmailTemplateDefinition[] = [
  ...
  },
  {
    ...
    label: "Welcome 1 — знакомство с платформой",
  ...
  },
  {
    ...
    label: "Welcome 2 — личный кабинет",
  ...
  },
  {
    ...
    label: "Welcome 3 — выбор первого курса",
  ...
  },
  {
    ...
    label: "Welcome 4 — возврат к платформе",
  ...
  },
  {
    ...
    label: "Welcome 5 — доведение до действия",
  ...
  },
  {
    ...
    label: "Expert welcome 1 — размещение экспертизы",
  ...
  },
  {
    ...
    label: "Expert welcome 2 — курс как продукт",
  ...
  },
  {
    ...
    label: "Expert welcome 3 — пилот и запуск",
