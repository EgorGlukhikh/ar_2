...
const showcaseCourses: ShowcaseCourse[] = [
  {
    ...
    lessons: [
      ...
      {
        title: "Договор с покупателем и карта сервиса без размытых обещаний",
        excerpt:
  ...
  },
  {
    ...
    title: "Листинг продавца: подготовка объекта, показы и несколько офферов",
    description:
  ...
  },
  {
    ...
    title: "Сделка с покупателем: финансирование, инспекция и закрытие сделки",
    description:
        "Платный курс о покупательской сделке: как вести клиента от бюджета и договора с покупателем до инспекции, оффера и финального закрытия.",
    offer: {
      name: "Покупательская сделка под ключ",
      description:
        "Платный трек про финансы покупателя, инспекцию, документы и закрытие сделки без потери контроля.",
      amount: 349000,
      currency: "RUB",
      isActive: true,
    },
    ...
    lessons: [
      ...
      {
        title: "Тест: от бюджета до закрытия сделки",
        excerpt:
          "Финальный тест по пути покупателя: финансирование, инспекция и закрытие сделки.",
        blocks: [
          {
            id: "buyer-5-homework",
            type: "HOMEWORK",
  ...
  },
  {
    ...
    offer: {
      ...
      description:
        "Открытый курс по равному доступу к жилью, безопасным показам и защите конфиденциальности клиента.",
      amount: 0,
      currency: "RUB",
      isActive: true,
    },
