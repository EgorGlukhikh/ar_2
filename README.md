...
Платформа обучения для проекта «Академия риэлторов». Внутри уже есть публичная витрина, каталог курсов, учебный кабинет, авторский контур и админская часть для управления курсами.
...
- demo checkout и выдача доступа
- demo-каталог с бесплатными и платными курсами
...
Это значит, что demo-курсы, bootstrap-пользователь и синхронизация legacy-уроков поднимаются без отдельного ручного шага.
